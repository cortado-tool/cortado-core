...
test_variant_4 = {  # Simple parallel tree
    "parallel": [{"leaf": ["x1"]}, {"leaf": ["x2"]}, {"leaf": ["x3"]}, {"leaf": ["x4"]}]
}

test_variant_5 = {  # follows with parallel children
    "follows": [
        {"parallel": [{"leaf": ["aa"]}, {"leaf": ["bb"]}]},
        {"parallel": [{"leaf": ["cc"]}, {"leaf": ["dd"]}, {"leaf": ["ee"]}]},
        {
            "parallel": [
                {"leaf": ["ff"]},
                {"leaf": ["gg"]},
...
test_variant_6 = {  # parallel with follows children
    "parallel": [
        {"follows": [{"leaf": ["aa"]}, {"leaf": ["bb"]}]},
        {"follows": [{"leaf": ["cc"]}, {"leaf": ["dd"]}, {"leaf": ["ee"]}]},
        {"follows": [{"leaf": ["ff"]}]},
    ]
}
    ...
    "follows": [
        {
            "parallel": [
                {"leaf": ["aa"]},
                {"leaf": ["bb"]},
                {"follows": [{"leaf": ["cc"]}, {"leaf": ["dd"]}]},
            ]
        },
        {
            "parallel": [
                {"follows": [{"leaf": ["ee"]}, {"leaf": ["ff"]}]},
                {"leaf": ["gg"]},
            ]
        },
        {"leaf": ["hhs"]},
