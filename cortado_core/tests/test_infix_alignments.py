...
from cortado_core.alignments.infix_alignments.algorithm import (
    calculate_optimal_infix_alignment,
)
from cortado_core.alignments.infix_alignments.algorithm import (
...
from cortado_core.alignments.infix_alignments.variants.tree_based_preprocessing import (
    reduce_process_tree,
    search_leaf_nodes_in_tree,
    get_matching_leaf_nodes,
)
...
class TestInfixAlignments(unittest.TestCase):
    ...
    def __test_tree(self, tree, acceptable_infixes, unacceptable_infixes):
        ...
        for variant in self.__get_variants():
            for infix in acceptable_infixes:
                ...
                self.assertLess(
                    alignment["cost"], align_utils.STD_MODEL_LOG_MOVE_COST, infix
                )
    ...
    def __get_variants(self):
        variant_dijkstra_naive = lambda t, pt: calculate_optimal_infix_alignment(
            t,
            pt,
            naive=True,
            use_dijkstra=True,
        ...
        variant_dijkstra_advanced = lambda t, pt: calculate_optimal_infix_alignment(
            t,
            pt,
            naive=False,
            use_dijkstra=True,
        ...
        variant_dijkstra_advanced_enforce_tau = (
            lambda t, pt: calculate_optimal_infix_alignment(
                t,
                pt,
                naive=False,
                use_dijkstra=True,
        ...
        variant_astar_naive = lambda t, pt: calculate_optimal_infix_alignment(
            t,
            pt,
            naive=True,
            use_dijkstra=False,
        ...
        variant_astar_advanced = lambda t, pt: calculate_optimal_infix_alignment(
            t,
            pt,
            naive=False,
            use_dijkstra=False,
        ...
        variant_baseline_dijkstra = lambda t, pt: calculate_optimal_infix_alignment(
            t, pt, use_dijkstra=True, naive=True, variant=VARIANT_BASELINE_APPROACH
        )
        variant_baseline_a_star = lambda t, pt: calculate_optimal_infix_alignment(
            t, pt, use_dijkstra=False, naive=True, variant=VARIANT_BASELINE_APPROACH
        )
        variant_baseline_not_naive_dijkstra = (
            lambda t, pt: calculate_optimal_infix_alignment(
                t, pt, use_dijkstra=True, naive=False, variant=VARIANT_BASELINE_APPROACH
            )
        )
        variant_baseline_not_naive_a_star = (
            lambda t, pt: calculate_optimal_infix_alignment(
                t,
                pt,
                use_dijkstra=False,
        ...
        return [
            variant_dijkstra_naive,
            variant_dijkstra_advanced,
            variant_astar_naive,
            variant_astar_advanced,
            variant_dijkstra_advanced_enforce_tau,
            variant_baseline_dijkstra,
            variant_baseline_a_star,
            variant_baseline_not_naive_dijkstra,
            variant_baseline_not_naive_a_star,
        ]
    ...
    def test_infix_alignments_basic_parallel_case_2(self):
        ...
        for variant in self.__get_variants():
            alignment = variant(trace, process_tree)
            self.assertGreaterEqual(
                alignment["cost"], align_utils.STD_MODEL_LOG_MOVE_COST
            )
    ...
    def test_reduce_process_tree(self):
        ...
        for data in test_data:
            ...
            matching_leaf_nodes = get_matching_leaf_nodes(
                set(data["activities_in_trace"]), all_leaf_nodes
            )
