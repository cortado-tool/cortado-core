...
class TestPerformance(unittest.TestCase):
    def test_no_deviation(self):
        log = [
            Trace(
                [
                    {
                        DEFAULT_NAME_KEY: "A",
                        DEFAULT_TIMESTAMP_KEY: timestamp(0),
                        DEFAULT_TRANSITION_KEY: "start",
                    },
                    {
                        DEFAULT_NAME_KEY: "A",
                        DEFAULT_TIMESTAMP_KEY: timestamp(3),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                    {
                        DEFAULT_NAME_KEY: "B",
                        DEFAULT_TIMESTAMP_KEY: timestamp(6),
                        DEFAULT_TRANSITION_KEY: "start",
                    },
                    {
                        DEFAULT_NAME_KEY: "B",
                        DEFAULT_TIMESTAMP_KEY: timestamp(10),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                    {
                        DEFAULT_NAME_KEY: "C",
                        DEFAULT_TIMESTAMP_KEY: timestamp(12),
                        DEFAULT_TRANSITION_KEY: "start",
                    },
                    {
                        DEFAULT_NAME_KEY: "C",
                        DEFAULT_TIMESTAMP_KEY: timestamp(17),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                    {
                        DEFAULT_NAME_KEY: "D",
                        DEFAULT_TIMESTAMP_KEY: timestamp(14),
                        DEFAULT_TRANSITION_KEY: "start",
                    },
                    {
                        DEFAULT_NAME_KEY: "D",
                        DEFAULT_TIMESTAMP_KEY: timestamp(20),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                    {
                        DEFAULT_NAME_KEY: "C",
                        DEFAULT_TIMESTAMP_KEY: timestamp(22),
                        DEFAULT_TRANSITION_KEY: "start",
                    },
                    {
                        DEFAULT_NAME_KEY: "C",
                        DEFAULT_TIMESTAMP_KEY: timestamp(25),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                    {
                        DEFAULT_NAME_KEY: "D",
                        DEFAULT_TIMESTAMP_KEY: timestamp(26),
                        DEFAULT_TRANSITION_KEY: "start",
                    },
                    {
                        DEFAULT_NAME_KEY: "D",
                        DEFAULT_TIMESTAMP_KEY: timestamp(28),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                    {
                        DEFAULT_NAME_KEY: "E",
                        DEFAULT_TIMESTAMP_KEY: timestamp(35),
                        DEFAULT_TRANSITION_KEY: "start",
                    },
                    {
                        DEFAULT_NAME_KEY: "E",
                        DEFAULT_TIMESTAMP_KEY: timestamp(38),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                    {
                        DEFAULT_NAME_KEY: "B",
                    ...
                    {
                        DEFAULT_NAME_KEY: "B",
                        DEFAULT_TIMESTAMP_KEY: timestamp(40),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                ]
            ),
        ...
        assert all_service_times[T0] == [
            [[[[0, 3], [6, 10], [12, 20], [22, 25], [26, 28], [35, 40]]]]
        ]
        ...
        assert all_cycle_times[T0] == [[[[0, 40]]]]

        assert all_waiting_times[T0] == [[[[0, 0]]]]
        ...
        # T11
        assert all_service_times[T11] == [
            [[[[0, 3], [6, 10], [12, 20], [22, 25], [26, 28]]]]
        ]
        ...
        log = [
            Trace(
                [
                    ...
                    {
                        DEFAULT_NAME_KEY: "A",
                        DEFAULT_TIMESTAMP_KEY: timestamp(5),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                    {
                        DEFAULT_NAME_KEY: "B",
                    ...
                    {
                        DEFAULT_NAME_KEY: "C",
                        DEFAULT_TIMESTAMP_KEY: timestamp(7),
                        DEFAULT_TRANSITION_KEY: "start",
                    },
                    {
                        DEFAULT_NAME_KEY: "C",
                        DEFAULT_TIMESTAMP_KEY: timestamp(8),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
                    ...
                    {
                        DEFAULT_NAME_KEY: "E",
                        DEFAULT_TIMESTAMP_KEY: timestamp(19),
                        DEFAULT_TRANSITION_KEY: "start",
                    },
                    {
                        DEFAULT_NAME_KEY: "E",
                        DEFAULT_TIMESTAMP_KEY: timestamp(21),
                        DEFAULT_TRANSITION_KEY: "complete",
                    },
