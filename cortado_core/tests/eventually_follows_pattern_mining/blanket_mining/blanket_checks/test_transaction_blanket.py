...
from cortado_core.eventually_follows_pattern_mining.blanket_mining.blanket_checks.transaction_blanket import (
    ...
    right_transaction_blanket_contains_elements,
)
...
class TestTransactionBlanket(unittest.TestCase):
    ...
    def test_right_occurrence_blanket_contains_elements_with_match(self):
        ...
        self.assertTrue(
            right_transaction_blanket_contains_elements(pattern, occurrence_list)
        )
