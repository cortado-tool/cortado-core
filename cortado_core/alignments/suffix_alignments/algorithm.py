...
def calculate_optimal_suffix_alignment(trace: Trace, process_tree: ProcessTree, naive: bool = True,
                                       ...
                                       timeout: int = sys.maxsize, use_cortado_tree_converter=True,
    ...
    try:
        if variant == VARIANT_BASELINE_APPROACH:
            net, im, fm, n_added_tau_transitions, unmodified_net_getter = build_extended_petri_net_for_infix_alignments_baseline(process_tree,
                                                                                                          trace, naive,
                                                                                                          timeout,
