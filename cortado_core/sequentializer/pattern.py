...
class SequentializerPattern:
    def __init__(
        self,
        labels: List[str] = None,
        operator: Union[cTreeOperator, WILDCARD_MATCH] = None,
        children: List = None,
        parent=None,
        id=-1,
...
def set_preorder_ids(pattern: SequentializerPattern, current_id=0):
...
def parse_sequentializer_pattern(string_rep):
    depth_cache = dict()
    depth = 0
