...
def check_concurrent_root_occurence_blanket_match(
    tp: CMTreePattern,
    node: CMConcurrencyTree,
    sibLabels: Set[str],
    expDir: ExpansionDirection,
):
...
def check_seq_root_occurence_blanket_match(
    tp: CMTreePattern,
    node: CMConcurrencyTree,
    sibLabels: Set[str],
    expDir: ExpansionDirection,
...
def compute_blanket_root_occurence_candidates(
    tp: CMTreePattern, tree: CMTreePattern, tid: int
):
